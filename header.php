<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<link rel="alternate" href="https://pregelmexico.com/" hreflang="es-mx" />
		...
		<!-- Google Analytics - PreGel Mexico -->
		<script>
		  ...
		  ga('create', 'UA-4623260-3', 'auto', {'allowLinker': true});
		  ga('require', 'linker');
          ga('linker:autoLink', ['https://mexico.pregel-itc.com/'] );
		  ga('send', 'pageview');
